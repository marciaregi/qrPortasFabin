...
class DoorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create door" do
    assert_difference('Door.count') do
      post doors_url, params: { door: { description: @door.description, number: @door.number, schedule: @door.schedule } }
    end
  ...
  test "should update door" do
    patch door_url(@door), params: { door: { description: @door.description, number: @door.number, schedule: @door.schedule } }
